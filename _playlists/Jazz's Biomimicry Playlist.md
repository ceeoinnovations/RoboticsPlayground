...
description
: In this hands-on design challenge, students take inspiration from plants and animals to design and build a retractable shade cover. To begin the challenge, students are guided through structure/function analysis of three organisms that are well-adapted to the task of extending and retracting a covering surface: flying squirrels, birds, and ground squirrels. After deepening their understanding of nature’s shading mechanisms, students then take inspiration from one or more of these animals to construct, test, and revise a device that can open and close a shade cover. They use LEGO Science Kits to build their prototypes, and a lamp or flashlight to test how well they shade the area beneath them.
...
===
title
: Treasure Exploration Robots (Digging)
...
===
title
: Fruit Harvesting Robots (Grasping)
...
===
title
: T-shirt Launcher Robot (Flinging)
